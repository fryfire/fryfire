...
function normalizeRect(x: number, y: number, width: number, height: number, anchor: Direction):
    ...
    if (Direction.isLeft(anchor)) {
        left = x + Math.min(0, width);
    } else if (Direction.isRight(anchor)) {
    ...
    if (Direction.isTop(anchor)) {
        top = y + Math.min(0, height);
    } else if (Direction.isBottom(anchor)) {
...
export class Rect implements RectLike, SizeLike, Serializable<RectJSON>, Equatable, PointLike {
     ...
     */
    public constructor(x: number, y: number, width: number, height: number, anchor = Direction.TOP_LEFT) {
     ...
     * @return The created rectangle.
     */
    public static fromSize(size: SizeLike, position: PointLike = Point.NULL, anchor = Direction.TOP_LEFT): Rect {
     ...
     */
    public getX(anchor: Direction = Direction.TOP_LEFT): number {
        if (Direction.isLeft(anchor)) {
            return this.getLeft();
        } else if (Direction.isRight(anchor)) {
     ...
     */
    public getY(anchor: Direction = Direction.TOP_LEFT): number {
        if (Direction.isTop(anchor)) {
            return this.getTop();
        } else if (Direction.isBottom(anchor)) {
     ...
     */
    public getLocation(anchor: Direction = Direction.TOP_LEFT): Point {
     ...
     * @return The new rectangle.
     */
    public setLocation(location: PointLike, anchor = Direction.TOP_LEFT): Rect {
     ...
     * @return The new rectangle.
     */
    public moveTo(x: number, y: number, anchor = Direction.TOP_LEFT): Rect {
     ...
     * @return The new rectangle.
     */
    public moveToPoint(point: PointLike, anchor = Direction.TOP_LEFT): Rect {
     ...
     * @return The new rectangle.
     */
    public resize(addWidth: number, addHeight: number, anchor = Direction.TOP_LEFT): Rect {
     ...
     * @return The new rectangle.
     */
    public addSize(size: SizeLike, anchor = Direction.TOP_LEFT): Rect {
     ...
     * @return The new rectangle.
     */
    public subSize(size: SizeLike, anchor = Direction.TOP_LEFT): Rect {
        return this.resize(-size.getWidth(), -size.getHeight(), anchor);
    }
     ...
     * @return The new rectangle.
     */
    public resizeTo(newWidth: number, newHeight: number, anchor = Direction.TOP_LEFT): Rect {
     ...
     * @return The new rectangle.
     */
    public setSize(size: SizeLike, anchor = Direction.TOP_LEFT): Rect {
     ...
     */
    public contains(x: number, y: number, width = 0, height = 0, anchor = Direction.TOP_LEFT): boolean {
     ...
     */
    public getIntersection(x: number, y: number, width: number, height: number, anchor = Direction.TOP_LEFT): Rect {
        let left: number, top: number;
        [ left, top, width, height ] = normalizeRect(x, y, width, height, anchor);
     ...
     */
    public intersects(x: number, y: number, width: number, height: number, anchor = Direction.TOP_LEFT): boolean {
        let left: number, top: number;
        [ left, top, width, height ] = normalizeRect(x, y, width, height, anchor);
        const right = left + width;
        const maxLeft = Math.max(left, this.left);
     ...
     */
    public add(x: number, y: number, width = 0, height = 0, anchor = Direction.TOP_LEFT): Rect {
        let left: number, top: number;
        [ left, top, width, height ] = normalizeRect(x, y, width, height, anchor);
