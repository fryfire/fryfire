...
export class Camera<T extends Game = Game> {
     ...
     */
    public getWidth() {
        return this.game.getWidth() / this.zoom;
    }
     ...
     */
    public getHeight() {
        return this.game.getHeight() / this.zoom;
    }
    ...
    public getSceneTransformation(): ReadonlyAffineTransform {
        if (!this.sceneTransformationValid) {
            this.sceneTransformation.reset()
                .translate(this.game.getWidth() / 2, this.game.getHeight() / 2)
    ...
    public update(timer: Timer): void {
        ...
        this.cinematicBars.update(timer);
        this.fadeToBlack.update(timer);
    }
